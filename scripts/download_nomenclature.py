...
def download_nomenclature():
    try:
        root_url = 'https://www2.chem.wisc.edu/areas/reich/handouts/nomenclature'
        page_name = 'func-groups.htm'

        data_filename = 'nomenclature_data'
