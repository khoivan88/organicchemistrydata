...
def download_electron_pushing():
    try:
        root_url = 'https://organicchemistrydata.org/epush'
        # page_name = 'epush-navigation.htm'

        # page_name = 'epush-general.htm'
        # page_name = 'epush-acidcatalysis.htm'
        page_name = 'epush-basecatalysis.htm'

        data_filename = 'electron_pushing_data'
